public class SortingHat {
			...
			do{
				...
				case 0: 
				 	if(gryffindor[gryffindor.length-1] == null){
					     ...
					     talkingHat();
					     System.out.println(nome + " " + "\u00E9 un.....Grifondoro!!!");
				...
				case 1: 
				 	if(slytherin[slytherin.length-1] == null){
						...
						talkingHat();
						System.out.println(nome + " " + "\u00E9 un.....Serpeverde!!!");
				...
				case 2: 
				 	if(hufflepuff[hufflepuff.length-1] == null){
						...
						talkingHat();
						System.out.println(nome + " " + "\u00E9 un.....Tassorosso!!!");
				...
				case 3: 
				 	if(ravenclaw[ravenclaw.length-1] == null){
						...
						talkingHat();
						System.out.println(nome + " " + "\u00E9 un.....Corvonero!!!");
		...
		System.out.println(java.util.Arrays.toString(gryffindor)+ " " + "Grifondoro");
